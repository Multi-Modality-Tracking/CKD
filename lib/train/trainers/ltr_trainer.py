        ...
        for i, data in enumerate(loader, 1):
            ...
            if loader.training:
                ...
                if not self.use_amp:
                    ...
                    if not i%getattr(self.actor.cfg.TRAIN, 'accumulate_grad_batches', 1) and i!=0:
                        self.optimizer.step()
                        clean_grad = True
                else:
                ...
                # 加额外传播3head
                # if self.actor.cfg.TRAIN.ACTIVATE_3HEAD and self.optimizer2!=None:
                #     loss, _ = self.actor(data, extra=True)
                ...
                #     else:
                #         self.scaler.scale(loss[1:]).backward()

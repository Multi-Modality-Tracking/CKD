    ...
    def load_checkpoint(self, checkpoint = None, fields = None, ignore_fields = None, load_constructor = False):
        ...
        for key in fields:
            ...
            if key == 'net':
                ...
                # 修正学习率
                # for i,item in enumerate(checkpoint_dict[key]['param_groups']):
                #     if i==0:
                #         if self.actor.cfg.TRAIN.LR_DROP_EPOCH > checkpoint_dict['epoch']:
                #             item['lr'] = self.actor.cfg.TRAIN.LR
                #         else:
                #             item['lr'] = self.actor.cfg.TRAIN.LR * self.actor.cfg.TRAIN.SCHEDULER.DECAY_RATE
                #         item['initial_lr'] = self.actor.cfg.TRAIN.LR
                #     if i==1:
                #         if self.actor.cfg.TRAIN.LR_DROP_EPOCH > checkpoint_dict['epoch']:
                #             item['lr'] = self.actor.cfg.TRAIN.LR / 10
                #         else:
                #             item['lr'] = self.actor.cfg.TRAIN.LR * self.actor.cfg.TRAIN.SCHEDULER.DECAY_RATE /10
                #         item['initial_lr'] = self.actor.cfg.TRAIN.LR

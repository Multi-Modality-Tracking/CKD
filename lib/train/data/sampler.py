    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                ...
                data = TensorDict({'template_images': template_frames*2,      # length=2
                                   'template_anno': template_anno['bbox'],  # length=1
                                   'template_masks': template_masks,        # length=1
                                   'search_images': search_frames*2,          # length=2
                                   'search_anno': search_anno['bbox'],      # length=1
                                   'search_masks': search_masks,            # length=1
